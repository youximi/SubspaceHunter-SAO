...
public class Test_sqlite : MonoBehaviour
{
 public TextMeshProUGUI textMeshProUGUI;
    public TextMeshProUGUI textMeshProUGUI2;
    private static Test_sqlite _dbInstance;
    public static Test_sqlite _DBInstance()
    {
    ...
    public void 测试读取数据()
    {
        foreach (var item in GetDataBySqlQuery("Player",new string[] { "First_enter"}))
         {
             Debug.Log(item);
